...
crimes <- readr::read_csv2("/Users/ottotavares/Library/Mobile Documents/com~apple~CloudDocs/Documents/infnet/Análise Exploratoria de Dados/dados_utilizados/BaseDPEvolucaoMensalCisp.csv", locale = readr::locale(encoding = "latin1"))
```
